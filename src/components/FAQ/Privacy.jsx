...
const Privacy = () => {
  return (
    ...
    <Main>
        ...
        Interestpro.org is the only data controller in full compliance with this Privacy Policy, which defines the procedure for the collection, processing, and use of the client’s personal data by the company as a data controller</p>
        <p style={{color:'gray', fontFamily: "Inter, arial, sans-serif", paddingTop: "2%", paddingLeft: "5%", width:"90%"}}>Interestpro.org and it’s affiliates guarantee and undertake to make every possible effort to protect the client's confidentiality. 
            <br /> 
       Interestpro.org may use the information collected about the customer to fulfill its contractual obligations and optimize customer service. <br /><br />
